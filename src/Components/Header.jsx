            ...
            <nav>
                <div className="flex flex-wrap justify-between items-center py-5.5 pl-6 pr-6 md:pr-13 md:pl-22 relative mt-0.5">
                            ...
                            <div className="account relative">
                                {isAuthenticated ? (
                                    <div className="relative">
                                        {/* User Icon Button */}
                                        <button
                                            className={`flex items-center gap-2 text-white ${isDropdownOpen ? 'text-champberry' : ''} hover:text-champberry transition-colors group cursor-pointer`}
                    ...
                    `}>
                        ...
                        <div className="absolute top-0 left-0 w-full h-1 bg-linear-to-r from-champberry-dark via-champberry-light to-champberry-dark"></div>
                                ...
                                <ul className='flex flex-col gap-4 font-medium text-lg'>
                                    <li>
                                        <a
                                            ...
                                            className='block py-4 px-4 uppercase tracking-wide border-l-4 transition-all duration-300 text-gray-300 border-transparent hover:text-champberry hover:border-champberry hover:bg-gray-900/30 hover:translate-x-2'
                                        >
                                    ...
                                    {isAuthenticated ? (
                                        ...
                                        >
                                            <div className="flex items-center gap-4">
                                                <div className="w-12 h-12 rounded-full bg-linear-to-br from-champberry to-champberry-dark flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
