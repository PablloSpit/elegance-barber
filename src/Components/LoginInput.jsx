...
function LoginInput() {
    ...
    return (
        <div className="login-box flex flex-col rounded-lg shadow-lg text-white w-full max-w-sm sm:max-w-md md:max-w-lg mx-auto">
            <div className="head bg-obsidian-elevated p-4 sm:p-5 text-center rounded-t-2xl text-champberry text-2xl sm:text-3xl md:text-4xl font-black uppercase" style={{ textShadow: "0 4px 4px rgba(0, 0, 0, 0.25)" }}>
                <h2>Login</h2>
            </div>
