    ...
    return (
        <div className="bg-obsidian-surface px-6 sm:px-8 pb-12 sm:pb-14 shadow-lg rounded-lg transition-all duration-500">
            <div className="head-background bg-obsidian-elevated w-[calc(100%+3rem)] sm:w-[calc(100%+4rem)] -mx-6 sm:-mx-8 -mt-8 px-6 sm:px-8 py-6 sm:py-8 mb-6 rounded-t-lg">
                <h2 className="text-2xl sm:text-3xl font-extrabold text-champberry mt-1"><span className="text-white">Submit</span> Feedback</h2>
            </div>
            <p className="text-champberry-muted mb-8 px-1">We'd love to hear about your experience</p>
            ...
            <form onSubmit={handleFeedbackSubmit} className="space-y-8">
                ...
                <div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-champberry-muted ml-4 text-lg">{feedbackData.rating} out of 5</span>
                    </div>
                </div>
