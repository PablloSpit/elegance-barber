                ...
                <div className="container mx-auto px-4 pb-12 md:pb-18">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 max-w-5xl mx-auto">
                        <button
                            ...
                            className={`group relative overflow-hidden bg-linear-to-br from-obsidian-elevated to-obsidian p-5 sm:p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-500 border ${activeTab === 'profile' ? 'border-champberry/40' : 'border-champberry/10 hover:border-champberry/40'} focus:outline-none focus:ring-2 focus:ring-champberry focus:ring-offset-2 focus:ring-offset-obsidian cursor-pointer`}
                        >
                            ...
                            <div className="relative flex items-center gap-6">
                                <div className="shrink-0">
                                    <div className={`w-14 h-14 rounded-full bg-linear-to-br from-champberry-light to-champberry flex items-center justify-center group-hover:shadow-2xl group-hover:shadow-champberry/50 transition-all duration-500 group-hover:scale-110`}>
                        ...
                        <button
                            ...
                            className={`group relative overflow-hidden bg-linear-to-br from-obsidian-elevated to-obsidian p-5 sm:p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-500 border ${activeTab === 'feedback' ? 'border-champberry/40' : 'border-champberry/10 hover:border-champberry/40'} focus:outline-none focus:ring-2 focus:ring-champberry focus:ring-offset-2 focus:ring-offset-obsidian cursor-pointer`}
                        >
                            {/* Animated background glow */}
                            <div className="absolute inset-0 bg-radial-gradient via-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" style={{
                                backgroundImage: 'radial-gradient(circle at center, rgba(217, 130, 43, 0.05) 0%, transparent 70%)'
                        ...
                        <button
                            ...
                            className={`group relative overflow-hidden bg-linear-to-br from-obsidian-elevated to-obsidian p-5 sm:p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-500 border ${activeTab === 'appointments' ? 'border-champberry/40' : 'border-champberry/10 hover:border-champberry/40'} focus:outline-none focus:ring-2 focus:ring-champberry focus:ring-offset-2 focus:ring-offset-obsidian cursor-pointer`}
                        >
                            {/* Animated background glow */}
                            <div className="absolute inset-0 bg-radial-gradient via-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" style={{
                                backgroundImage: 'radial-gradient(circle at center, rgba(217, 130, 43, 0.05) 0%, transparent 70%)'
