            ...
            <section className="bg-obsidian">
                <div className="container mx-auto pt-16 pb-18 px-4 flex justify-center items-center flex-col">
                    <div className="section-text text-center space-y-2">
                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white leading-tight"><span className="text-champberry">READY FOR</span> NEW LOOK</h2>
                        <p className="text-base sm:text-lg text-champberry-muted">Schedule your appointment or send us a message</p>
                    </div>
                </div>
                <div className="container mx-auto px-4 pb-12 md:pb-18">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-5xl mx-auto">
                        <a href="tel:+923001234567" className="group relative overflow-hidden bg-linear-to-br from-obsidian-elevated to-obsidian p-5 sm:p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-champberry/10 hover:border-champberry/40 focus:outline-none focus:ring-2 focus:ring-champberry focus:ring-offset-2 focus:ring-offset-obsidian">
                            ...
                            <div className="relative flex items-center gap-6">
                                ...
                                <div className="shrink-0">
                                    <div className="w-13 h-13 sm:w-14 sm:h-14 rounded-full bg-linear-to-br from-champberry-light to-champberry flex items-center justify-center group-hover:shadow-2xl group-hover:shadow-champberry/50 transition-all duration-500 group-hover:scale-110">
                                ...
                                <div className="flex-1 text-left">
                                    <h3 className="font-bold text-base sm:text-lg text-white uppercase tracking-wider mb-0.5 group-hover:text-champberry-light transition-colors duration-300">Phone</h3>
                                    <p className="text-sm mb-2 text-champberry-muted group-hover:text-champberry-muted transition-colors">Mon-Fri 10am-8pm</p>
                                    <p className="font-semibold text-champberry text-base group-hover:text-champberry-light transition-colors duration-300">+92 300 1234567</p>
                                </div>
                        ...
                        <a href="mailto:info@elegance.com" className="group relative overflow-hidden bg-linear-to-br from-obsidian-elevated to-obsidian p-5 sm:p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-champberry/10 hover:border-champberry/40 focus:outline-none focus:ring-2 focus:ring-champberry focus:ring-offset-2 focus:ring-offset-obsidian">
                            {/* Animated background glow */}
                            <div className="absolute inset-0 bg-radial-gradient via-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" style={{
                                backgroundImage: 'radial-gradient(circle at center, rgba(217, 130, 43, 0.05) 0%, transparent 70%)'
                            }}></div>
                            ...
                            <div className="relative flex items-center gap-6">
                                ...
                                {/* Content */}
                                <div className="flex-1 text-left">
                                    <h3 className="font-bold text-base sm:text-lg text-white uppercase tracking-wider mb-0.5 group-hover:text-champberry-light transition-colors duration-300">Email</h3>
                                    <p className="text-sm  text-champberry-muted mb-1 group-hover:text-champberry-muted transition-colors">24/7 Support</p>
                                    <p className="font-semibold text-champberry text-base group-hover:text-champberry-light transition-colors duration-300">info@elegance.com</p>
                                </div>
                        ...
                        <a href="https://wa.me/923001234567" target="_blank" className="group relative overflow-hidden bg-linear-to-br from-obsidian-elevated to-obsidian p-5 sm:p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-champberry/10 hover:border-champberry/40 focus:outline-none focus:ring-2 focus:ring-champberry focus:ring-offset-2 focus:ring-offset-obsidian">
                            {/* Animated background glow */}
                            <div className="absolute inset-0 bg-radial-gradient via-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" style={{
                                backgroundImage: 'radial-gradient(circle at center, rgba(217, 130, 43, 0.05) 0%, transparent 70%)'
                            }}></div>
                            ...
                            <div className="relative flex items-center gap-6">
                                ...
                                {/* Content */}
                                <div className="flex-1 text-left">
                                    <h3 className="font-bold text-base sm:text-lg text-white uppercase tracking-wider mb-0.5 group-hover:text-champberry-light transition-colors duration-300">Whatsapp</h3>
                                    <p className="text-sm text-champberry-muted mb-1 group-hover:text-champberry-muted transition-colors">Quick Response</p>
                                    <p className="font-semibold text-champberry text-base group-hover:text-champberry-light transition-colors duration-300">Chat Now</p>
                                </div>
                ...
                <div className="container max-w-7xl mx-auto pb-14 px-4 gap-10 md:gap-12 lg:gap-14 grid grid-cols-1 lg:grid-cols-2 pt-8">
                    <div className="section-form bg-obsidian-surface px-6 sm:px-8 pb-12 sm:pb-14 shadow-lg w-full flex flex-col items-start rounded-lg transition-all duration-500">
                        <div className="head-background bg-obsidian-elevated w-[calc(100%+3rem)] sm:w-[calc(100%+4rem)] -mx-6 sm:-mx-8 -mt-8 px-6 sm:px-8 py-6 sm:py-8 mb-6 transition-all duration-500 rounded-t-lg ">
                            <h2 className="text-2xl sm:text-3xl font-extrabold text-champberry mt-1"><span className="text-white">Make An</span> Appointment</h2>
                        </div>
                    ...
                    <div className="store-section mt-8 lg:mt-0 px-6 md:px-8 pb-12 md:pb-0">
                        <div className="visit-store-section">
                            <div className="head-background bg-obsidian-elevated w-[calc(100%+3rem)] sm:w-[calc(100%+4rem)] -mx-6 sm:-mx-8 -mt-8 px-6 sm:px-8 py-8 sm:py-10 mb-5 transition-all duration-500 rounded-t-lg">
                                <h2 className="text-2xl sm:text-3xl font-extrabold text-champberry"><span className="text-white">Visit Our</span> Store</h2>
                            </div>
                                ...
                                <div className="space-y-6">
                                    <div className="space-y-6">
                                        <div className="flex gap-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-map-pin h-5 w-5 text-champberry mt-1 shrink-0"><path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0"></path><circle cx="12" cy="10" r="3"></circle></svg>
                                            <div>
                                                <h3 class="font-semibold mb-1 text-white text-base sm:text-lg">Address</h3>
                                                <p class="text-champberry-muted text-sm sm:text-base font-semibold leading-relaxed">123 Main Street, Gulberg III <br /> Lahore, Punjab 54000<br></br> Pakistan</p>
                                            </div>
                                        </div>
                                        <div className="flex gap-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-clock h-5 w-5 text-champberry mt-1 shrink-0"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
                                            <div>
                                                <h3 class="font-semibold mb-1 text-white text-base sm:text-lg">Business Hours</h3>
                                                <div class="space-y-1 text-sm sm:text-base text-champberry-muted">
