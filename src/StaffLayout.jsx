                ...
                <header className="h-14 sm:h-16 lg:h-20 bg-obsidian/80 backdrop-blur-xl border-b border-white/5 flex items-center justify-between px-3 sm:px-6 lg:px-8 z-30 top-0">
                    <div className="flex items-center gap-6">
                        <button
                            ...
                            className="lg:hidden p-2 text-champberry-muted hover:text-champberry hover:bg-white/5 rounded-xl transition-all duration-200 cursor-pointer"
                        >
                            <Menu size={20} />
                        </button>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        <div className="hidden sm:block text-right mr-4">
                            ...
                            <div className="text-xs text-champberry uppercase tracking-wider">{currentUser?.role || 'Staff'}</div>
                        </div>
